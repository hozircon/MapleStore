...
INSERT INTO item (item_id, name, category, sub_category, equip_type, equip_sub_type, str_bonus, dex_bonus, int_bonus, luk_bonus, atk_bonus, matk_bonus, scroll_slots_remaining, other_stats, price_type, price_value, quantity, location, seller_name, status, featured, created_at, updated_at)
...
INSERT INTO item (item_id, name, category, sub_category, equip_type, equip_sub_type, str_bonus, dex_bonus, int_bonus, luk_bonus, atk_bonus, matk_bonus, scroll_slots_remaining, price_type, price_value, quantity, location, seller_name, status, featured, created_at, updated_at)
